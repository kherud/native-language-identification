...
\caption{Dreidimensionale \textit{Principal Component Analysis}-Projektion des internen Modellzustands $X_d$ (siehe \autoref{eq:d}) von den Klassen USA (blau), China (rot) und UK (rosa). Erstellt mittels \url{https://projector.tensorflow.org/}.}
\end{figure}
